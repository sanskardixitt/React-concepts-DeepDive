...
function sayH(age, address) {
  return "hello" + this.name + "is" + age + "address is " + address;
}

console.log(sayH.call(objj, 5));
const bindF = sayH.bind(objj);
console.log(bindF(55, " kanpur"));
/* call()

Calls a function immediately.

You can set this explicitly and pass arguments comma-separated. */
